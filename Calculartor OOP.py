...
class Calculator:
    ...
    def button_press(self,value):
        if value =="AC":
            ...
            entry_val += value  # Cause it is still a string!
            self.number_entry.delete(0,"end")
            self.number_entry.insert(0,entry_val)
    ...
    def __init__(self,root):
        ...
        command=lambda:self.button_press("1")).grid(row=3,
        column=0,sticky=(W,E))
        self.button2 = ttk.Button(root,text="2",
        command=lambda:self.button_press("2")).grid(row=3,
        column=1,sticky=(W,E))
        self.button3 = ttk.Button(root,text="3",
        command=lambda:self.button_press("3")).grid(row=3,
        column=2,sticky=(W,E))
        ...
        command=lambda:self.button_press("AC")).grid(row=4,
        column=0,sticky=(W,E))
        self.button0 = ttk.Button(root,text="0").grid(row=4,
        column=1,sticky=(W,E))
